# To-do list app with enhanced file error handling
import csv
import datetime
import os

def save_tasks(tasks, filename="data/tasks.txt"):
    # NEW: Fine-grained exception handling for file errors
    error_log = []  # NEW: Centralized error logging for file operations
    try:
        ...
        # NEW: User-friendly error messages with recovery actions
        ...
        # NEW: Handle specific OSError (e.g., disk full, invalid path)
